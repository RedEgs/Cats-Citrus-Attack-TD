...
class Menu(Scene):
    def __init__(self, screen, scene_director, scene_name):
        ...
        self.play_button_tween = TweenVector2(TweenData((self.center_pos[0], self.center_pos[1]+500), (self.center_pos[0], 300), 2, .5, pytweening.easeInOutCubic), self.tween_director)
        ...
        self.options_button_tween = TweenVector2(TweenData((self.center_pos[0], self.center_pos[1]+500), (self.center_pos[0], 386), 2, .75, pytweening.easeInOutCubic), self.tween_director)
