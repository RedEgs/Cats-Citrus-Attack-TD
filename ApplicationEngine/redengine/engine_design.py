...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        icon32 = QIcon()
        icon32.addFile(u"assets/10125_icons/imageres_185.ico", QSize(), QIcon.Normal, QIcon.Off)
        self.menuRecent_Projects.setIcon(icon32)
        self.menuPreferences = QMenu(self.project_button)
        self.menuPreferences.setObjectName(u"menuPreferences")
        icon33 = QIcon()
        icon33.addFile(u"assets/10125_icons/shell32_16826.ico", QSize(), QIcon.Normal, QIcon.Off)
        self.menuPreferences.setIcon(icon33)
        self.menuThemes = QMenu(self.menuPreferences)
        self.menuThemes.setObjectName(u"menuThemes")
        icon34 = QIcon()
        icon34.addFile(u"assets/10125_icons/imageres_117.ico", QSize(), QIcon.Normal, QIcon.Off)
        self.menuThemes.setIcon(icon34)
