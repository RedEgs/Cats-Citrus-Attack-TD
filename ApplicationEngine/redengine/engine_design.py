...
"color: rgb(255, 255, 255);")
        ...
        self.toolBoxPage1.setGeometry(QRect(0, 0, 302, 544))
        ...
        self.toolBoxPage2.setGeometry(QRect(0, 0, 302, 544))
        ...
        self.toolBoxPage3.setGeometry(QRect(0, 0, 302, 544))
        icon55 = QIcon()
        icon55.addFile(u"../redengine/assets/icons/application-monitor.png", QSize(), QIcon.Normal, QIcon.Off)
        self.debug_menu_toolbox.addItem(self.toolBoxPage3, icon55, u"Python Debug Information")
