...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        icon22 = QIcon()
        icon22.addFile(u"../redengine/assets/icons-shadowless/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionProject_Settings.setIcon(icon22)
        self.actionCut = QAction(main_window)
        self.actionCut.setObjectName(u"actionCut")
        icon23 = QIcon()
        icon23.addFile(u"../redengine/assets/icons-shadowless/scissors-blue.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionCut.setIcon(icon23)
        self.actionCopt = QAction(main_window)
        self.actionCopt.setObjectName(u"actionCopt")
        icon24 = QIcon()
        icon24.addFile(u"../redengine/assets/icons-shadowless/blue-document-copy.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionCopt.setIcon(icon24)
        self.actionPaste = QAction(main_window)
        self.actionPaste.setObjectName(u"actionPaste")
        icon25 = QIcon()
        icon25.addFile(u"../redengine/assets/icons-shadowless/clipboard.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionPaste.setIcon(icon25)
        self.actionFind = QAction(main_window)
        self.actionFind.setObjectName(u"actionFind")
        icon26 = QIcon()
        icon26.addFile(u"../redengine/assets/icons-shadowless/magnifier.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionFind.setIcon(icon26)
        self.actionReplace = QAction(main_window)
        self.actionReplace.setObjectName(u"actionReplace")
        icon27 = QIcon()
        icon27.addFile(u"../redengine/assets/icons-shadowless/arrow-circle-double.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionReplace.setIcon(icon27)
        self.actionGenerate_Main_py = QAction(main_window)
        self.actionGenerate_Main_py.setObjectName(u"actionGenerate_Main_py")
        icon28 = QIcon()
        icon28.addFile(u"assets/py.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionGenerate_Main_py.setIcon(icon28)
        self.actionGenerate_Script = QAction(main_window)
        self.actionGenerate_Script.setObjectName(u"actionGenerate_Script")
        icon29 = QIcon()
        icon29.addFile(u"assets/py1.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionGenerate_Script.setIcon(icon29)
        self.actionRename = QAction(main_window)
        self.actionRename.setObjectName(u"actionRename")
        icon30 = QIcon()
        icon30.addFile(u"../redengine/assets/icons/application-rename.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRename.setIcon(icon30)
        self.actionSet_as_Main_py = QAction(main_window)
        self.actionSet_as_Main_py.setObjectName(u"actionSet_as_Main_py")
        icon31 = QIcon()
        icon31.addFile(u"../redengine/assets/icons/red-python.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionSet_as_Main_py.setIcon(icon31)
        ...
        icon32 = QIcon()
        icon32.addFile(u"../redengine/assets/icons/folder--arrow.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionOpen_in_File_Explorer.setIcon(icon32)
        ...
        icon33 = QIcon()
        icon33.addFile(u"../redengine/assets/icons/document-copy.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionCopy_Path.setIcon(icon33)
        self.actionExample_Script = QAction(main_window)
        self.actionExample_Script.setObjectName(u"actionExample_Script")
        icon34 = QIcon()
        icon34.addFile(u"../redengine/assets/icons/document-py.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionExample_Script.setIcon(icon34)
        self.actionExample_Main = QAction(main_window)
        self.actionExample_Main.setObjectName(u"actionExample_Main")
        icon35 = QIcon()
        icon35.addFile(u"../redengine/assets/icons/document-mainpy.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionExample_Main.setIcon(icon35)
        ...
        icon36 = QIcon()
        icon36.addFile(u"../redengine/assets/icons/arrow-circle-135.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionReload.setIcon(icon36)
        ...
        icon37 = QIcon()
        icon37.addFile(u"../redengine/assets/icons-shadowless/cross.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionClear_All_Recent_Projects.setIcon(icon37)
        self.actionCompile_Project = QAction(main_window)
        self.actionCompile_Project.setObjectName(u"actionCompile_Project")
        icon38 = QIcon()
        icon38.addFile(u"../redengine/assets/icons-shadowless/hammer-screwdriver.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionCompile_Project.setIcon(icon38)
        self.actionPause_Project = QAction(main_window)
        self.actionPause_Project.setObjectName(u"actionPause_Project")
        icon39 = QIcon()
        icon39.addFile(u"../redengine/assets/icons/control-pause.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionPause_Project.setIcon(icon39)
        self.actionRun_In_Fullscreen = QAction(main_window)
        self.actionRun_In_Fullscreen.setObjectName(u"actionRun_In_Fullscreen")
        icon40 = QIcon()
        icon40.addFile(u"../redengine/assets/icons/controller-d-pad.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRun_In_Fullscreen.setIcon(icon40)
        self.actionPropertiesWindow = QAction(main_window)
        self.actionPropertiesWindow.setObjectName(u"actionPropertiesWindow")
        icon41 = QIcon()
        icon41.addFile(u"../redengine/assets/icons/application-detail.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionPropertiesWindow.setIcon(icon41)
        self.actionPopout_Viewport = QAction(main_window)
        self.actionPopout_Viewport.setObjectName(u"actionPopout_Viewport")
        icon42 = QIcon()
        icon42.addFile(u"../redengine/assets/icons/application-export.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionPopout_Viewport.setIcon(icon42)
        self.actionReturnLauncher = QAction(main_window)
        self.actionReturnLauncher.setObjectName(u"actionReturnLauncher")
        icon43 = QIcon()
        icon43.addFile(u"../redengine/assets/icons/rocket--arrow.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionReturnLauncher.setIcon(icon43)
        self.actionRevert_Themes = QAction(main_window)
        self.actionRevert_Themes.setObjectName(u"actionRevert_Themes")
        icon44 = QIcon()
        icon44.addFile(u"../redengine/assets/icons/paint-brush--minus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRevert_Themes.setIcon(icon44)
        ...
        self.pause_button.setIcon(icon39)
        ...
        icon45 = QIcon()
        icon45.addFile(u"../redengine/assets/icons/control-stop.png", QSize(), QIcon.Normal, QIcon.Off)
        self.stop_button.setIcon(icon45)
        ...
        icon46 = QIcon()
        icon46.addFile(u"../redengine/assets/icons/arrow-circle-double.png", QSize(), QIcon.Normal, QIcon.Off)
        self.reload_button.setIcon(icon46)
        ...
        self.resources_dock.setMinimumSize(QSize(320, 200))
...
"color: rgb(255, 255, 255);")
        ...
        self.debug_menu_dock.setMinimumSize(QSize(320, 300))
...
"}")
        ...
        icon48 = QIcon()
        icon48.addFile(u"../redengine/assets/icons/computer--arrow.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButton.setIcon(icon48)
        ...
        icon49 = QIcon()
        icon49.addFile(u"../redengine/assets/icons/computer.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon50 = QIcon()
        icon50.addFile(u"../redengine/assets/icons/application-block.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.menu_bar.setGeometry(QRect(0, 0, 1283, 22))
        ...
        icon54 = QIcon()
        icon54.addFile(u"../redengine/assets/icons-shadowless/paint-brush.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuThemes.setIcon(icon54)
        self.menuLoad_Themes = QMenu(self.menuThemes)
        self.menuLoad_Themes.setObjectName(u"menuLoad_Themes")
        icon55 = QIcon()
        icon55.addFile(u"../redengine/assets/icons/paint-brush--arrow.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuLoad_Themes.setIcon(icon55)
        ...
        self.properties_search_bar = QLineEdit(self.properties_tab_1)
        self.properties_search_bar.setObjectName(u"properties_search_bar")
        self.properties_search_bar.setFrame(True)

        self.verticalLayout_14.addWidget(self.properties_search_bar)
        ...
        icon56 = QIcon()
        icon56.addFile(u"../redengine/assets/icons/magnifier.png", QSize(), QIcon.Normal, QIcon.Off)
        self.properties_tabs.addTab(self.properties_tab_1, icon56, "")
        ...
        icon57 = QIcon()
        icon57.addFile(u"../redengine/assets/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        self.properties_tabs.addTab(self.properties_tab_2, icon57, "")
        ...
        self.windows_button.addSeparator()
    ...
    def retranslateUi(self, main_window):
        ...
        self.debug_menu_toolbox.setItemText(self.debug_menu_toolbox.indexOf(self.toolBoxPage3), QCoreApplication.translate("main_window", u"Python Debug Information", None))
        ...
        self.properties_search_bar.setInputMask(QCoreApplication.translate("main_window", u"0", None))
